...
if part4.title() == 'Y':
    ...
    class Printer(StoreMashines):
        def to_print(self):
            return f'Принтер - {self.numb} '


    class Scanner(StoreMashines):
        def to_scan(self):
            return f'Сканер - {self.numb} '


    class Copier(StoreMashines):
        def to_copier(self):
            return f'Копир - {self.numb} '

    answer = ''
    while answer.title() != 'Y':
        unit = Printer('', 0, 0, 'b/w')
        print(unit.reception())
        print(unit.to_print())
        # print(unit.to_copier())
        answer = input('Закончить выполнение задания 4-6? (Y/N) ')
...
if part7.title() == 'Y':
    ...
    answer = ''
    while answer.title() != 'Y':
        z_1 = ComplexNumber(int(input('Введите вещественную часть комплексного числа z1, a: ')),
                            int(input('Введите мнимую часть комплексного числа z1, b: ')))
        z_2 = ComplexNumber(int(input('Введите вещественную часть комплексного числа z2, a: ')),
                            int(input('Введите мнимую часть комплексного числа z1, b: ')))
        print('z\u2081', z_1)
        print('z\u2082', z_2)
        print('z\u2081\u208a\u2082', z_1 + z_2)
        print('z\u2081\u2093\u2082', z_1 * z_2)
        answer = input('Закончить выполнение задания 7? (Y/N) ')
